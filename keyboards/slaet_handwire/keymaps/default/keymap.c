...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_Numbers] = LAYOUT_slaet_layout(
        KC_NO, KC_EXSL,   KC_BSLS,   KC_LCBR,   KC_RCBR,   KC_PIPE,     /**/        KC_NO,   KC_7,   KC_8,  KC_9,	KC_ASTR,    KC_EQL,
        KC_NO, KC_HASH,   KC_DLR,    KC_LPRN,   KC_RPRN,   KC_DOT,      /**/        KC_NO,   KC_4,   KC_5,	KC_6,	KC_PLUS,    KC_MINS,
        KC_NO, KC_SLSH,   KC_CIRC,   KC_LBRC,   KC_RBRC,   KC_TILD,     /**/        KC_NO,   KC_1,   KC_2,  KC_3,   KC_SLSH,    KC_AMPR,
